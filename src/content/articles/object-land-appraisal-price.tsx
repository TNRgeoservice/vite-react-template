...
export const meta: ArticleMeta = {
  ...
  title:       'ราคาประเมินที่ดินไม่ตรงความจริง? วิธียื่นคัดค้านกับกรมธนารักษ์',
  description: 'ราคาประเมินทรัพย์สินสูงหรือต่ำเกินจริง ยื่นคัดค้านได้ภายใน 90 วัน สรุปแบบฟอร์ม บค.1/บค.2/บค.3 เอกสารที่ต้องเตรียม ยื่นที่ไหน ขั้นตอนพิจารณา และสิทธิฟ้องศาลปกครอง',
  excerpt:     'ราคาประเมินที่ดินไม่ตรงสภาพจริง สูงเกินไปก็จ่ายภาษี/ค่าโอนแพงเกิน ต่ำเกินไปก็เสียประโยชน์ — ยื่นคัดค้านกับกรมธนารักษ์ได้ภายใน 90 วัน สรุปแบบฟอร์ม เอกสาร สถานที่ยื่น ครบ',
  date:        '2026-06-05',
    ...
    <article style={{ color: C.text }}>
      <header style={{ marginBottom: 32 }}>
        <h1 style={{ fontSize: 32, fontWeight: 900, lineHeight: 1.25, margin: '0 0 10px', color: '#fff' }}>
          ราคาประเมินที่ดินไม่ตรงความจริง? คัดค้านได้
        </h1>
      ...
      <Section title="ทำไมต้องสนใจ ถ้าราคาประเมินผิด?">
        <p style={p}>
          ...
          ราคาที่ผิดจากความจริงทำให้เสียประโยชน์ได้ทั้งสองทาง: สูงเกินไปก็จ่ายภาษีและค่าโอนแพงเกิน
          ส่วนต่ำเกินไปก็กระทบเวลานำไปใช้อ้างอิงมูลค่า เช่น ขอสินเชื่อหรือเรียกค่าทดแทน
        </p>
        <p style={p}>
      ...
      <Section title="เอกสารที่ต้องเตรียม">
        ...
        <p style={{ ...p, fontSize: 13.5, color: C.muted, marginTop: 12 }}>
          ดาวน์โหลดแบบฟอร์มคัดค้าน (บค.1 / บค.2 / บค.3) ได้ที่{' '}
          <a href="https://dep-valstd.treasury.go.th/th/download-form/" target="_blank" rel="noopener noreferrer nofollow" style={{ color: C.cyan, wordBreak: 'break-all' }}>
            dep-valstd.treasury.go.th/th/download-form
          </a>
        </p>
      </Section>
